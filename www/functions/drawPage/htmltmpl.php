...
/*  htmltmpl
    ...
    CVS:            $Id: htmltmpl.php,v 1.16 2003/01/02 03:22:48 tripiecz Exp $
*/

define('_VERSION', 1.22);
define('_AUTHOR', 'Tomas Styblo <tripie@cpan.org>');

# $HTMLTMPL_DEBUG = "/tmp/htmltmpl.log";
    ...
    function set($var, $value=NULL) {
        ...
        if (is_array($var) && $value == NULL) {
            foreach ($var as $mkey => $mvalue) {
                ...
                _DEB("VALUE SET: $mkey => ".$this->_vars[$mkey]);
            }
        }
        else {
            $this->_vars[$var] =& $value;
            _DEB("VALUE SET: $var => ".$this->_vars[$var]);
        }
    }
